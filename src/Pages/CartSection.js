...
<div className='px-[1.6rem] mdlg:px-[5.5rem] lg:px-36 xl:px-48 pt-10'>
...
<div className='flex justify-between mt-3'>
  <NavLink to="/product">
    <button className='px-3 py-2 bg-slate-500 hover:bg-slate-400 text-white'>Continue Shopping</button>
  </NavLink>
  <button onClick={clearCart} className='px-3 py-2 bg-red-500 hover:bg-red-400 text-white'>Clear Cart</button>
</div>


{/* subtotal */}
<div className=" w-full capitalize flex justify-end items-end my-8">
          <div className=" flex  flex-col border-[0.1rem] border-solid border-[#f0f0f0] gap-6 py-8 px-4">
